...
from database import Category, Base, Items
...
Item2 = Items(name="soccer ball", description="fsgsd",
...
Item2 = Items(name="Frisball shoes", description="dsfaf", price="$5.50",
              category=Category4)
session.add(Item2)
session.commit()


# add Items for Snowbording
...
Item2 = Items(name="Snowbording goggles", description="safasaf",
              price="$5.50", category=Category5)
session.add(Item2)
session.commit()


# add Items for Rockclimbing
...
Item2 = Items(name='shoes rockclimb',
              description='Juicy grilled chicken patty'
              'with tomato mayo and lettuce',
              price='$5.50', category=Category6)
session.add(Item2)
session.commit()


# add Items for Foosball
